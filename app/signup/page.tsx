...
import { Eye, EyeOff, Check, MessageCircle, Loader2 } from "lucide-react"
import {
  Dialog,
  DialogContent,
  DialogHeader,
...
export default function SignupPage() {
  ...
  const handleSignup = (e: React.FormEvent) => {
    ...
    startTransition(async () => {
      ...
      formData.set("marketing_agreed", String(agreeMarketing))
        ...
        <div className="w-full max-w-[440px]">
          ...
          <form onSubmit={handleSignup} className="flex flex-col gap-5">
            ...
            <div className="mt-4">
              ...
              >
                {isPending ? <Loader2 className="h-5 w-5 animate-spin" /> : "회원가입하기"}
              </button>
            </div>
          </form>
